export const COMPANY_INFO = {
  name: "AgentFlow",
  tagline: "Enterprise AI Conversational Agent Platform",
  description: "Deploy intelligent conversational agents across WhatsApp, Telegram, Discord, and more. Automate customer interactions while maintaining personalized, context-aware conversations that drive results.",
